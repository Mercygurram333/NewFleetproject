    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-600">{stats.availableVehicles} available</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">of {stats.totalDrivers} total</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Deliveries in Progress</p>
              <p className="text-3xl font-bold text-gray-900">{stats.deliveriesInProgress}</p>
              <p className="text-sm text-blue-600">{stats.deliveriesToday} today</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-red-600">{stats.pendingRequests} pending</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">John Smith delivered to Downtown - 5 min ago</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">Sarah Johnson - Airport pickup - 12 min ago</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">FL-003 scheduled for service - 1 hour ago</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-white shadow-lg transition-all duration-300 ease-in-out flex flex-col`}>
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            {sidebarOpen && (
              <div>
                <h1 className="text-xl font-bold text-gray-900">Fleet Admin</h1>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">admin@fleet.com</div>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">{stats.activeDrivers} Active Drivers</span>
              </div>
              <div className="flex items-center space-x-2">
                <Package className="h-4 w-4 text-blue-500" />
                <span className="text-sm text-gray-600">{stats.deliveriesInProgress} In Progress</span>
              </div>
              {stats.systemAlerts > 0 && (
                <div className="flex items-center space-x-2">
                  <AlertTriangle className="h-4 w-4 text-red-500" />
                  <span className="text-sm text-red-600">{stats.systemAlerts} Alerts</span>
                </div>
              )}
            </div>
          </div>
